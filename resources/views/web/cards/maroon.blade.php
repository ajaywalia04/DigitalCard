    ...
    <div class="card-container bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-105 relative">
        ...
        <div class="text-center pt-16 pb-8 px-6">
            ...
            <div class="space-y-3 text-left max-w-xs mx-auto">
                <div class="flex items-center text-gray-700">
                    ...
                    <a href="mailto:jane.doe@example.com" class="text-red-700 hover:text-red-900 transition-colors duration-200">{{ $myCard->email }}</a>
                </div>
                <div class="flex items-center text-gray-700">
                    <span class="icon">&#128222;</span>
                    <a href="tel:+1234567890" class="text-red-700 hover:text-red-900 transition-colors duration-200">+91 {{ $myCard->phone_no}}</a>
                </div>
                <div class="flex items-center text-gray-700">
                    <span class="icon">&#128205;</span>
        ...
        <div class="px-6 pb-6 pt-4">
             <form method="Post" action="{{ route('my.card.accept',['myCard'=>$myCard->slug]) }}">
                @csrf
                <button type="submit" class="w-full bg-red-600 text-white py-3 rounded-md font-semibold hover:bg-red-700 transition-colors duration-200 shadow-md mb-2">
                    Accept Card
                </button>
            </form>
