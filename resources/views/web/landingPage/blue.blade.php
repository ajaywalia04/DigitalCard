...
<head>
    ...
    <style>
        ...
        .container {
            max-width: 960px; /* Slightly narrower container for personal page focus */
            margin: 0 auto;
            padding: 0 20px;
        }
        .hero-section {
            ...
            position: relative;
            overflow: hidden; /* Hide overflow from any animations/elements */
            color: white;
            text-align: center; /* Default to center for mobile, adjust for desktop */
            display: flex;
            align-items: center;
        ...
        @media (min-width: 768px) {
            .hero-content-wrapper {
                ...
                align-items: center;
                text-align: left; /* Align text content to left on desktop */
        ...
        .social-icon-wrapper {
            ...
            height: 2.5rem;
            border-radius: 50%;
            background-color: #1f2937; /* Darker gray background for icons (gray-900) */
            display: flex;
            justify-content: center;
            align-items: center;
        ...
        .social-icon-wrapper img {
            width: 1.25rem; /* Icon size within the circle */
            height: 1.25rem;
            object-fit: contain; /* Ensures the image fits without distortion */
        }
        .btn-primary-hero {
            background: linear-gradient(to right, #6366f1, #8b5cf6); /* Indigo-500 to Purple-500 */
        ...
        .btn-secondary-hero {
            @apply bg-transparent text-white border border-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300 transform hover:-translate-y-1;
        }

        .contact-form input[type="text"],
        .contact-form input[type="email"],
        .contact-form textarea {
            @apply mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200;
        }
        .contact-form label {
            @apply block text-sm font-medium text-gray-700 text-left mb-1;
        }

        /* Redesigned Services/Projects Section Styles */
        .service-card {
            background-color: #ffffff;
            padding: 1.5rem;
            border-radius: 12px;
...
<body>
    ...
    <!-- User's Hero Section - Redesigned -->
        ...
        <div class="container relative z-10 hero-content-wrapper">
            ...
            <div class="hero-image-content">
                <div class="hero-card-display-wrapper">
                    ...
                    <img src="https://placehold.co/200x120/4f46e5/FFFFFF?text=Hello" alt="Digital Business Card" class="hero-card-display">
    ...
    <main class="bg-white pt-12 pb-12 shadow-lg rounded-b-xl">
        ...
        <!-- Services / Projects Section - Redesigned -->
        ...
        <section id="contact" class="section-spacing bg-gray-50 rounded-xl mx-auto max-w-2xl px-6 py-12 shadow-inner">
            ...
            <form action="{{ route('landing.contact.store',['landingPage'=> $landingPage->uuid])}}" method="POST" class="space-y-6 contact-form">
                ...
                <div>
                    ...
                    <textarea id="message" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200" name="message" rows="5" required placeholder="Tell me about your project or question..."></textarea>
                </div>
                <div>
    ...
    <footer class="bg-gray-900 text-gray-300 py-10">
        <div class="container text-center text-sm">
            <p>&copy; 2025 DigitalCardPro. All rights reserved.</p>
        </div>
    </footer>
