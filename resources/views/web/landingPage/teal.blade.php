...
<head>
    ...
    <style>
        body {
            ...
            background-color: #f0fdfa; /* Light teal-gray background */
            margin: 0;
            padding: 0;
        ...
        .hero-section {
            background: linear-gradient(to right, #0d9488, #0f766e); /* Teal-600 to Teal-700 */
            padding: 60px 0 80px;
            position: relative;
            overflow: hidden;
            color: white;
        ...
        .btn-primary-hero {
            background: linear-gradient(to right, #2dd4bf, #14b8a6); /* Teal-400 to Teal-500 */
        ...
        .btn-secondary-hero {
            @apply bg-transparent text-white border border-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-teal-600 transition-all duration-300 transform hover:-translate-y-1;
        }

        .contact-form input[type="text"],
        .contact-form input[type="email"],
        .contact-form textarea {
            @apply mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm transition-all duration-200;
        }
        .contact-form label {
    ...
    <section class="hero-section">
        <div class="container relative z-10 hero-content-wrapper">
            ...
            <div class="hero-text-content">
                ...
                <p class="text-lg text-teal-100 leading-relaxed mb-8">
            ...
            <div class="hero-image-content">
                <div class="hero-card-display-wrapper">
                    ...
                    <img src="https://placehold.co/200x120/0d9488/FFFFFF?text=Hello" alt="Digital Business Card" class="hero-card-display">
