...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(to right, #4b5563, #374151); /* Gray-700 to Gray-800 */
            padding: 60px 0 80px;
            position: relative;
            overflow: hidden;
            color: white;
        ...
        .btn-primary-hero {
            background: linear-gradient(to right, #6b7280, #4b5563); /* Gray-500 to Gray-700 */
        ...
        .btn-secondary-hero {
            @apply bg-transparent text-white border border-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-gray-700 transition-all duration-300 transform hover:-translate-y-1;
        }

        .contact-form input[type="text"],
        .contact-form input[type="email"],
        .contact-form textarea {
            @apply mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm transition-all duration-200;
        }
        .contact-form label {
        ...
        <div class="container relative z-10 hero-content-wrapper">
            ...
            <div class="hero-image-content">
                <div class="hero-card-display-wrapper">
                    ...
                    <img src="https://placehold.co/200x120/4b5563/FFFFFF?text=Hello" alt="Digital Business Card" class="hero-card-display">
