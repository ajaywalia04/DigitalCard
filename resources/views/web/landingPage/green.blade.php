...
<head>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(to right, #16a34a, #047857); /* Green-600 to Green-700 */
            padding: 60px 0 80px;
            position: relative;
            overflow: hidden;
            color: white;
        ...
        .btn-primary-hero {
            background: linear-gradient(to right, #22c55e, #10b981); /* Green-500 to Green-600 */
        ...
        .btn-secondary-hero {
            @apply bg-transparent text-white border border-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-green-600 transition-all duration-300 transform hover:-translate-y-1;
        }

        .contact-form input[type="text"],
        .contact-form input[type="email"],
        .contact-form textarea {
            @apply mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm transition-all duration-200;
        }
        .contact-form label {
        ...
        <div class="container relative z-10 hero-content-wrapper">
            ...
            <div class="hero-image-content">
                <div class="hero-card-display-wrapper">
                    ...
                    <img src="https://placehold.co/200x120/16a34a/FFFFFF?text=Hello" alt="Digital Business Card" class="hero-card-display">
