...
@push('css')
    <link rel="stylesheet" href="{{ asset('css/blade/tag.css') }}">
@endpush
@section("content")
    ...
    <div class="dashboard-main container">
        ...
        <main id="dashboardMainContent" class="main-content rounded-lg shadow-md">
            ...
            <p class="text-gray-700 mb-6">
                Create and edit your custom tags to organize your contacts.
            </p>

            <div class="bg-white p-6 rounded-lg shadow-sm">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">Your Tags</h2>
                <div class="scrollable-table-container mb-4">
                    @if($tags->count() >0)
                    <table class="manage-table">
                        <thead>
                            <tr>
                                <th class="w-2/3">Tag Name</th>
                    ...
                    @else
                        <div id="noTagsMessage" class="p-4 text-center text-gray-500">No custom tags yet.</div>
                    @endif
                </div>
            </div>
        </main>
