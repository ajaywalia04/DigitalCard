...
@section('content')
    ...
    <div class="dashboard-main container">
        ...
        <main id="dashboardMainContent" class="main-content rounded-lg shadow-md">
            ...
            <!-- Digital Business Card Display - Green Corporate -->
                ...
                <div class="relative bg-green-700 h-32 flex items-center justify-center">
                    <?php
                        $initials = strtoupper(collect(explode(' ', trim($mycard->fullname)))
                                ...
                                ->implode(''));
                        ?>
                    <img src={{ "https://placehold.co/100x100/065f46/FFFFFF?text=".$initials }} alt="Profile Picture" class="w-24 h-24 rounded-full border-4 border-white shadow-lg -mb-12 relative z-10 object-cover">
                </div>
                ...
                <div class="text-center pt-16 pb-8 px-6">
                    ...
                    <div class="space-y-3 text-left max-w-xs mx-auto">
                        <div class="flex items-center text-gray-700">
                            ...
                            <span class="text-green-600">{{ $mycard->email }}</span>
                        </div>
                        <div class="flex items-center text-gray-700">
                            <span class="card-display-icon">&#128222;</span>
                            <span class="text-green-600">+91 {{ $mycard->phone_no}}</span>
                        </div>
                        <div class="flex items-center text-gray-700">
                            <span class="card-display-icon">&#128205;</span>
