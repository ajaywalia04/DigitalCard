...
@push('css')
    <link rel="stylesheet" href="{{ asset('css/blade/createNewCard.css') }}">
@endpush
@section("content")
                ...
                <form action="{{ route('dashboard.card.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="card_no" name="card_no" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200">
                            <option value="blue" {{ old('card_no') == 'blue' ? 'selected' : '' }}>Blue Professional</option>
                            <option value="green" {{ old('card_no') == 'green' ? 'selected' : '' }} >Green Corporate</option>
                            <option value="maroon" {{ old('card_no') == 'maroon' ? 'selected' : '' }} >Maroon Elegance</option>
                            <option value="gray" {{ old('card_no') == 'gray' ? 'selected' : '' }}>Minimalist Gray</option>
                            <option value="teal" {{ old('card_no') == 'teal' ? 'selected' : '' }}>Teal Modern</option>
                        </select>
                    </div>
